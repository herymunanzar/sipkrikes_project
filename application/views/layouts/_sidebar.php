    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="<?= base_url('kajian_resikos') ?>" aria-expanded="false">
                ...
                <?php if ($this->session->userdata('role') == 'admin') : ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="<?= base_url('kajian_resiko') ?>" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="<?= base_url('kuesioner_kajian_resikos') ?>" aria-expanded="false">
                        <i data-feather="users" class="feather-icon"></i>
                        <span class="hide-menu">List Data</span>
                    </a>
                </li>
                <?php if ($this->session->userdata('role') == 'admin') : ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="<?= base_url('kuesioner_kajian_resiko') ?>" aria-expanded="false">
                            <i data-feather="user-plus" class="feather-icon"></i>
                            <span class="hide-menu">Tambah Data</span>
                        </a>
                    </li>
                ...
                <li class="sidebar-item"> 
                    <a class="sidebar-link sidebar-link" href="<?= base_url('pelaporans') ?>" aria-expanded="false">
                        <i data-feather="users" class="feather-icon"></i>
                        <span class="hide-menu">List Data</span>
                    </a>
                </li>
                <?php if ($this->session->userdata('role') == 'admin') : ?>
                    <li class="sidebar-item"> 
                        <a class="sidebar-link sidebar-link" href="<?= base_url('pelaporan') ?>" aria-expanded="false">
                            <i data-feather="user-plus" class="feather-icon"></i>
                            <span class="hide-menu">Tambah Data</span>
                        </a>
                    </li>
                ...
                <!-- Submemu Penilaian -->
                <li class="nav-small-cap"><span class="hide-menu">Penilaian</span></li>
                <li class="sidebar-item"> 
                    <a class="sidebar-link sidebar-link" href="<?= base_url('penilaians') ?>" aria-expanded="false">
                        <i data-feather="users" class="feather-icon"></i>
                        <span class="hide-menu">List Data</span>
                    </a>
                </li>
                <?php if ($this->session->userdata('role') == 'admin') : ?>
                    <li class="sidebar-item"> 
                        <a class="sidebar-link sidebar-link" href="<?= base_url('penilaian') ?>" aria-expanded="false">
                            <i data-feather="user-plus" class="feather-icon"></i>
                            <span class="hide-menu">Tambah Data</span>
                        </a>
                    </li>
                ...
                <li class="sidebar-item"> 
                    <a class="sidebar-link sidebar-link" href="<?= base_url('cabangs') ?>" aria-expanded="false">
                        <i data-feather="users" class="feather-icon"></i>
                        <span class="hide-menu">List Data</span>
                    </a>
                </li>
                <?php if ($this->session->userdata('role') == 'admin') : ?>
                    <li class="sidebar-item"> 
                        <a class="sidebar-link sidebar-link" href="<?= base_url('cabang') ?>" aria-expanded="false">
                            <i data-feather="user-plus" class="feather-icon"></i>
                            <span class="hide-menu">Tambah Data</span>
                        </a>
                    </li>
