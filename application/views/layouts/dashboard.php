...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="500x500" href="<?= base_url('assets/images/logorhanobg.png') ?>">
    <title><?= $title ?></title>
    <!-- CSS Libraries -->
...
<body>
    ...
    <!-- Page level plugins -->
    <!-- <script src="<?php //echo base_url(); ?>/assets/libs/vendor/chart2.js/Chart.min.js"></script> -->
    ...
    <!-- ==============================================================
    This is for combobox select prov show kabupaten kota
    ============================================================== -->
    <script type="text/javascript">
        $(document).ready(function(){
            $('#prov-option').change(function(){
                var id=$(this).val();
                $.ajax({
                    url : "<?php echo site_url('listkabkot');?>",
                    method : "POST",
                    data : {id: id},
                    async : true,
                    dataType : 'json',
