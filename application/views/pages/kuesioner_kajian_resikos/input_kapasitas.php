                            ...
                            <div class="form-group">
                                ...
                                <table class="table-bordered font-11" >
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="kebijakan_dinas_identifikasi"> Melakukan </input>
                                                <input type="radio" value="tidak melakukan" name="kebijakan_dinas_identifikasi" checked> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="penguatan_dinkes_memiliki_program"> Memiliki </input>
                                                <input type="radio" value="tidak memiliki" name="penguatan_dinkes_memiliki_program" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ya, sebagian atau seluruh" name="penguatan_dinkes_memfasilitasi"> Ya, sebagian /seluruh fasyankes telah dilakukan penilaian risiko</input>
                                                <input type="radio" value="ya, sebagian kecil" name="penguatan_dinkes_memfasilitasi"> Ya, sebagian kecil fasyankes telah dilakukan penilaian risiko</input>
                                                <input type="radio" value="belum ada" name="penguatan_dinkes_memfasilitasi" checked> Belum ada sama sekali </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="penguatan_ketenagaan_unit"> Ada, dengan latar belakang pendidikan .... </input>
                                                <input type="radio" value="tidak ada" name="penguatan_ketenagaan_unit" checked> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="penguatan_tim_penyelidikan_epidemiologi"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="penguatan_tim_penyelidikan_epidemiologi" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="penguatan_tim_reaksi_cepat"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="penguatan_tim_reaksi_cepat" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="penguatan_peningkatan">Ada</input>
                                                <input type="radio" value="tidak ada" name="penguatan_peningkatan" checked>Tidak Ada</input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td>3. </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ya, sebagian atau seluruh" name="peringatan_sistem"> Ya, sebagian / seluruh ancaman bencana sudah ada sistem peringatan dininya</input>
                                                <input type="radio" value="ya, sebagian kecil" name="peringatan_sistem"> Ya, tapi hanya sebagian kecil ancaman bencana yang ada sistem peringatan dininya</input>
                                                <input type="radio" value="tidak ada" name="peringatan_sistem" checked> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td>4.</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="mitigasi_fasilitas_kepada_masyarakat"> Melakukan</input>
                                                <input type="radio" value="tidak melakukan" name="mitigasi_fasilitas_kepada_masyarakat" checked> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="mitigasi_peta_kapasitas"> Memiliki </input>
                                                <input type="radio" value="tidak memiliki" name="mitigasi_peta_kapasitas" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="mitigasi_peta_kelompok_rentan"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="mitigasi_peta_kelompok_rentan" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="mitigasi_peta_ancaman"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="mitigasi_peta_ancaman" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ya" name="mitigasi_alokasi_anggaran"> Ya</input>
                                                <input type="radio" value="tidak" name="mitigasi_alokasi_anggaran" checked> Tidak </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_menyusun_rencana"> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_menyusun_rencana" checked> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="kesiapsiaga_melakukan_simulasi"> Melakukan</input>
                                                <input type="radio" value="tidak melakukan" name="kesiapsiaga_melakukan_simulasi" checked> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_sop_penaganan"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_sop_penaganan" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_sop_obat"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_sop_obat" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_sop_bantuan_relawan"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_sop_bantuan_relawan" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_sop_pemantauan"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_sop_pemantauan" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_sop_pelaporan"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_sop_pelaporan" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_sop_pelayanan_rujukan"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_sop_pelayanan_rujukan" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_sop_pelayanan_kesehatan"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_sop_pelayanan_kesehatan" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ya" name="kesiapsiaga_dana_tak_terduga"> Ya</input>
                                                <input type="radio" value="tidak" name="kesiapsiaga_dana_tak_terduga" checked> Tidak</input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ya" name="kesiapsiaga_paham_dsp_bnpb"> Ya</input>
                                                <input type="radio" value="tidak" name="kesiapsiaga_paham_dsp_bnpb" checked> Tidak</input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_sarana"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_sarana" checked> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_psc_24jam"> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_psc_24jam" checked> Tidak Memiliki</input>
                                            </fieldset></td>
                                    </tr>
                                </table>
                            </div>
