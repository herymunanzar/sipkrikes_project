                                ...
                                <table class="table table-bordered no-wrap v-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-top-0 text-muted px-1 py-0 font-14">21</td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"><?= $penguatan?></td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"><?= $hasil_tidak_sesuai_penguatan = 21 - $penguatan?></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"><?= $hasil_tidak_sesuai_peringatan_dini = 1 - $peringatan_dini?></td>
                                        </tr>
                                        <tr>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14">4</td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14">Mitigasi</td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14">10</td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"><?= $mitigasi?></td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"><?= $hasil_tidak_sesuai_mitigasi = 10 - $mitigasi?></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="border-top-0 text-muted px-1 py-0 font-14">15</td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"><?= $kesiapsiagaan?></td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"><?= $hasil_tidak_sesuai_kesiapsiagaan = 15 - $kesiapsiagaan?></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="border-top-0 text-muted px-1 py-0 font-14">55</td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"><?= $total?></td>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"><?= $hasil_tidak_sesuai_total = 55 - $total?></td>
                                        </tr>
                                        <tr>
                                            <td class="border-top-0 text-muted px-1 py-0 font-14"></td>
