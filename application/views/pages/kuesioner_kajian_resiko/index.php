                    ...
                    <form action="<?= base_url('kuesioner_kajian_resiko') ?>" method="POST">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-7">
                                    <div class="row">
                                        <div class="col-md-12">
                                                <div class="input-group">
                                            <?= form_input('karakteristik_jumlah_kec', $input->karakteristik_jumlah_kec, ['class' => 'form-control', 'placeholder' => 'Masukkan jumlah kabupaten/kota ']) ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                        ...
                        <div class="form-actions">
                            <div class="text-right">
                                ...
                                <a href="<?= base_url('kuesioner_kajian_resiko/reset') ?>" class="btn btn-dark">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
