...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">EDIT KAJIAN RISIKO KRISIS KESEHATAN PROVINSI</h4>
                    <form action="<?= base_url("kajian_resikos/edit/$input->id") ?>" method="POST">
                        <div class="form-body">
                            <!-- provinsi  -->
                            <div class="row">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-5 pb-1 pb-lg-0"><span class="ml-0 ml-lg-3">2. Alamat</span> </div>
                                <div class="col-lg-7">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-group">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-5 pb-1 pb-lg-0"><span class="ml-0 ml-lg-3">3. Telepon</span></div>
                                <div class="col-lg-7">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-group">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-5 pb-1 pb-lg-0"><span class="ml-0 ml-lg-3">4. Fax</span></div>
                                <div class="col-lg-7">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-group">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-5 pb-1 pb-lg-0"><span class="ml-0 ml-lg-3">5. Website</span></div>
                                <div class="col-lg-7">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-group">
