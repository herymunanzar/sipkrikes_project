                            ...
                            <div class="form-group">
                                ...
                                <table class="table-bordered font-11" >
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ya" name="kebijakan_dinas_identifikasi" <?php if($input->kebijakan_dinas_identifikasi == 'ya') echo 'checked'; ?>> Ya </input>
                                                <input type="radio" value="tidak" name="kebijakan_dinas_identifikasi" <?php if($input->kebijakan_dinas_identifikasi == 'tidak') echo 'checked'; ?>> Tidak </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="penguatan_bina_teknis" <?php if($input->penguatan_bina_teknis == 'melakukan') echo 'checked'; ?>> Melakukan </input>
                                                <input type="radio" value="tidak melakukan" name="penguatan_bina_teknis" <?php if($input->penguatan_bina_teknis == 'tidak melakukan') echo 'checked'; ?>> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="penguatan_sdm" <?php if($input->penguatan_sdm == 'ada') echo 'checked'; ?>> Ada, dengan latar belakang pendidikan .... </input>
                                                <input type="radio" value="tidak ada" name="penguatan_sdm" <?php if($input->penguatan_sdm == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="penguatan_phrrt" <?php if($input->penguatan_phrrt == 'memiliki') echo 'checked'; ?>> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="penguatan_phrrt" <?php if($input->penguatan_phrrt == 'tidak memiliki') echo 'checked'; ?>> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="penguatan_emt" <?php if($input->penguatan_emt == 'memiliki') echo 'checked'; ?>> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="penguatan_emt" <?php if($input->penguatan_emt == 'tidak memiliki') echo 'checked'; ?>> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="penguatan_peningkatan" <?php if($input->penguatan_peningkatan == 'melakukan') echo 'checked'; ?>> Melakukan</input>
                                                <input type="radio" value="tidak melakukan" name="penguatan_peningkatan" <?php if($input->penguatan_peningkatan == 'tidak melakukan') echo 'checked'; ?>> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td>3. </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="peringatan_sosialisasi" <?php if($input->peringatan_sosialisasi == 'melakukan') echo 'checked'; ?>> Melakukan</input>
                                                <input type="radio" value="tidak melakukan" name="peringatan_sosialisasi" <?php if($input->peringatan_sosialisasi == 'tidak melakukan') echo 'checked'; ?>> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="peringatan_sistem" <?php if($input->peringatan_sistem == 'melakukan') echo 'checked'; ?>> Melakukan</input>
                                                <input type="radio" value="tidak melakukan" name="peringatan_sistem" <?php if($input->peringatan_sistem == 'tidak melakukan') echo 'checked'; ?>> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td>4.</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="mitigasi_bina_teknis" <?php if($input->mitigasi_bina_teknis == 'melakukan') echo 'checked'; ?>> Melakukan</input>
                                                <input type="radio" value="tidak melakukan" name="mitigasi_bina_teknis" <?php if($input->mitigasi_bina_teknis == 'tidak melakukan') echo 'checked'; ?>> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="mitigasi_peningkatan" <?php if($input->mitigasi_peningkatan == 'melakukan') echo 'checked'; ?>> Melakukan</input>
                                                <input type="radio" value="tidak melakukan" name="mitigasi_peningkatan" <?php if($input->mitigasi_peningkatan == 'tidak melakukan') echo 'checked'; ?>> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="mitigasi_peta_sdm" <?php if($input->mitigasi_peta_sdm == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="mitigasi_peta_sdm" <?php if($input->mitigasi_peta_sdm == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="mitigasi_peta_kelompok_rentan" <?php if($input->mitigasi_peta_kelompok_rentan == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="mitigasi_peta_kelompok_rentan" <?php if($input->mitigasi_peta_kelompok_rentan == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="mitigasi_peta_ancaman" <?php if($input->mitigasi_peta_ancaman == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="mitigasi_peta_ancaman" <?php if($input->mitigasi_peta_ancaman == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="mitigasi_alokasi_anggaran" <?php if($input->mitigasi_alokasi_anggaran == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="mitigasi_alokasi_anggaran" <?php if($input->mitigasi_alokasi_anggaran == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="melakukan" name="kesiapsiaga_fasilitas" <?php if($input->kesiapsiaga_fasilitas == 'melakukan') echo 'checked'; ?>> Melakukan</input>
                                                <input type="radio" value="tidak melakukan" name="kesiapsiaga_fasilitas" <?php if($input->kesiapsiaga_fasilitas == 'tidak melakukan') echo 'checked'; ?>> Tidak Melakukan </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_dok_rekon" <?php if($input->kesiapsiaga_dok_rekon == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_dok_rekon" <?php if($input->kesiapsiaga_dok_rekon == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_sop_obat" <?php if($input->kesiapsiaga_sop_obat == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_sop_obat" <?php if($input->kesiapsiaga_sop_obat == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_sop_bantuan_relawan" <?php if($input->kesiapsiaga_sop_bantuan_relawan == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_sop_bantuan_relawan" <?php if($input->kesiapsiaga_sop_bantuan_relawan == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_sop_pemantauan" <?php if($input->kesiapsiaga_sop_pemantauan == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_sop_pemantauan" <?php if($input->kesiapsiaga_sop_pemantauan == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_sop_pelaporan" <?php if($input->kesiapsiaga_sop_pelaporan == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_sop_pelaporan" <?php if($input->kesiapsiaga_sop_pelaporan == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_sop_pelayanan_rujukan" <?php if($input->kesiapsiaga_sop_pelayanan_rujukan == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_sop_pelayanan_rujukan" <?php if($input->kesiapsiaga_sop_pelayanan_rujukan == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_sop_pelayanan_kesehatan" <?php if($input->kesiapsiaga_sop_pelayanan_kesehatan == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_sop_pelayanan_kesehatan" <?php if($input->kesiapsiaga_sop_pelayanan_kesehatan == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_dana_tak_terduga" <?php if($input->kesiapsiaga_dana_tak_terduga == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_dana_tak_terduga" <?php if($input->kesiapsiaga_dana_tak_terduga == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="ada" name="kesiapsiaga_paham_dsp_bnpb" <?php if($input->kesiapsiaga_paham_dsp_bnpb == 'ada') echo 'checked'; ?>> Ada</input>
                                                <input type="radio" value="tidak ada" name="kesiapsiaga_paham_dsp_bnpb" <?php if($input->kesiapsiaga_paham_dsp_bnpb == 'tidak ada') echo 'checked'; ?>> Tidak Ada </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><fieldset id="group1">
                                                <input type="radio" value="memiliki" name="kesiapsiaga_sarana_khusus" <?php if($input->kesiapsiaga_sarana_khusus == 'memiliki') echo 'checked'; ?>> Memiliki</input>
                                                <input type="radio" value="tidak memiliki" name="kesiapsiaga_sarana_khusus" <?php if($input->kesiapsiaga_sarana_khusus == 'tidak memiliki') echo 'checked'; ?>> Tidak Memiliki </input>
                                            </fieldset></td>
                                    </tr>
                                    <tr>
                                        <td></td>
