                            ...
                            <div class="form-group">
                                ...
                                <table class="table-bordered font-11" >
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->penguatan_bina_teknis ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->penguatan_sdm ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->penguatan_phrrt ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><ol start="13"><li>EMT</li></ol></td>
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->penguatan_emt ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->peringatan_sosialisasi ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->mitigasi_bina_teknis ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->mitigasi_peningkatan ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->mitigasi_peta_sdm ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->kesiapsiaga_fasilitas ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><ol start="34"><li>Memiliki Dokumen renkon bidang kesehatan untuk bencana tingkat provinsi</li></ol></td>
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->kesiapsiaga_dok_rekon ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform:capitalize;" class="text-center"><?= $input->kesiapsiaga_sarana_khusus ?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
