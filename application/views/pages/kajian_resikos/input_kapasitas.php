                                    ...
                                    <table class="table table-sm table-style-border" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ya" name="kebijakan_dinas_identifikasi"> Ya </label>
                                                        <label><input type="radio" value="tidak" name="kebijakan_dinas_identifikasi" checked> Tidak </label>
                                                    </fieldset>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="melakukan" name="penguatan_bina_teknis"> Melakukan </label>
                                                        <label><input type="radio" value="tidak melakukan" name="penguatan_bina_teknis" checked> Tidak Melakukan </label>
                                                    </fieldset>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="penguatan_sdm"> Ada, dengan latar belakang pendidikan .... </label>
                                                        <label><input type="radio" value="tidak ada" name="penguatan_sdm" checked> Tidak Ada </label>
                                                    </fieldset>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="memiliki" name="penguatan_phrrt"> Memiliki</label>
                                                        <label><input type="radio" value="tidak memiliki" name="penguatan_phrrt" checked> Tidak Memiliki </label>
                                                    </fieldset>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="memiliki" name="penguatan_emt"> Memiliki</label>
                                                        <label><input type="radio" value="tidak memiliki" name="penguatan_emt" checked> Tidak Memiliki </label>
                                                    </fieldset>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="melakukan" name="penguatan_peningkatan"> Melakukan</label>
                                                        <label><input type="radio" value="tidak melakukan" name="penguatan_peningkatan" checked> Tidak Melakukan </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td>3. </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="melakukan" name="peringatan_sosialisasi"> Melakukan</label>
                                                        <label><input type="radio" value="tidak melakukan" name="peringatan_sosialisasi" checked> Tidak Melakukan </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="melakukan" name="peringatan_sistem"> Melakukan</label>
                                                        <label><input type="radio" value="tidak melakukan" name="peringatan_sistem" checked> Tidak Melakukan </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td>4.</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="melakukan" name="mitigasi_bina_teknis"> Melakukan</label>
                                                        <label><input type="radio" value="tidak melakukan" name="mitigasi_bina_teknis" checked> Tidak Melakukan </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="melakukan" name="mitigasi_peningkatan"> Melakukan</label>
                                                        <label><input type="radio" value="tidak melakukan" name="mitigasi_peningkatan" checked> Tidak Melakukan </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="mitigasi_peta_sdm"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="mitigasi_peta_sdm" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="mitigasi_peta_kelompok_rentan"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="mitigasi_peta_kelompok_rentan" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="mitigasi_peta_ancaman"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="mitigasi_peta_ancaman" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="mitigasi_alokasi_anggaran"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="mitigasi_alokasi_anggaran" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="melakukan" name="kesiapsiaga_fasilitas"> Melakukan</label>
                                                        <label><input type="radio" value="tidak melakukan" name="kesiapsiaga_fasilitas" checked> Tidak Melakukan </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="kesiapsiaga_dok_rekon"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="kesiapsiaga_dok_rekon" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="kesiapsiaga_sop_obat"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="kesiapsiaga_sop_obat" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="kesiapsiaga_sop_bantuan_relawan"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="kesiapsiaga_sop_bantuan_relawan" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="kesiapsiaga_sop_pemantauan"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="kesiapsiaga_sop_pemantauan" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="kesiapsiaga_sop_pelaporan"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="kesiapsiaga_sop_pelaporan" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="kesiapsiaga_sop_pelayanan_rujukan"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="kesiapsiaga_sop_pelayanan_rujukan" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="kesiapsiaga_sop_pelayanan_kesehatan"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="kesiapsiaga_sop_pelayanan_kesehatan" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="kesiapsiaga_dana_tak_terduga"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="kesiapsiaga_dana_tak_terduga" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="ada" name="kesiapsiaga_paham_dsp_bnpb"> Ada</label>
                                                        <label><input type="radio" value="tidak ada" name="kesiapsiaga_paham_dsp_bnpb" checked> Tidak Ada </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><fieldset class="d-flex flex-column gap-2">
                                                        <label><input type="radio" value="memiliki" name="kesiapsiaga_sarana_khusus"> Memiliki</label>
                                                        <label><input type="radio" value="tidak memiliki" name="kesiapsiaga_sarana_khusus" checked> Tidak Memiliki </label>
                                                    </fieldset></td>
                                            </tr>
                                            <tr>
                                                <td></td>
