                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top-0 text-center text-muted px-1 py-0">
                                            <?php if($row->id_kapasitas == null) {?>
                                                <a href="<?= base_url("kapasitas_kajian_resikos/input_kapasitas/$row->id") ?>" class="btn btn-sm">
                                                    <i class="fas fa-pencil-alt text-info"></i>
                                                </a>
                                            <?php }else{ ?>
                                                <a href="<?= base_url("kapasitas_kajian_resikos/detail/$row->id") ?>" class="btn btn-sm">
                                        ...
                                        <?php }else { ?>
                                            <a href="<?= base_url("kajian_resikos/kesimpulan/$row->id") ?>" class="btn btn-sm">
                                                <i class="fas fa-chart-bar text-info"></i>
                                            </a>
                                        <?php } ?>
                                        </td>
                                        <td class="border-top-0 text-center text-muted px-1 py-0">
                                            <a href="<?= base_url("kajian_resikos/hapus/$row->id") ?>" class="btn btn-sm">
