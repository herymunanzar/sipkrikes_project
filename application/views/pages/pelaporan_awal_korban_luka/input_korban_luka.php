                    ...
                    <form action="<?= base_url('pelaporan_awal_korban_luka/input_korban_luka/'.$data->id) ?>" method="POST">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-lg-4">Nama Fasilitas Pelayanan</label>
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-12">
                                ...
                                <br>
                                <div class="row">
                                    <label class="col-lg-4">Jumlah Rawat Inap Laki - laki</label>
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                ...
                                <br>
                                <div class="row">
                                    <label class="col-lg-4">Jumlah Rawat Inap Perempuan</label>
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                ...
                                <br>
                                <div class="row">
                                    <label class="col-lg-4">Jumlah Rawat Jalan Laki - Laki</label>
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                ...
                                <br>
                                <div class="row">
                                    <label class="col-lg-4">Jumlah Rawat Jalan Perempuan</label>
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
