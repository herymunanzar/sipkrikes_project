                    ...
                    <form action="<?= base_url('pelaporan_awal_fasilitas_kesehatan/input_fasilitas_kesehatan/'.$data->id) ?>" method="POST">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-lg-4">Nama Fasilitas Kesehatan</label>
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-12">
                                ...
                                <br>
                                <div class="row">
                                    <label class="col-lg-4">Kondisi Fasilitas Kesehatan</label>
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                ...
                                <br>
                                <div class="row">
                                    <label class="col-lg-4">Fungsi Pelayanan Fasilitas Kesehatan</label>
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
