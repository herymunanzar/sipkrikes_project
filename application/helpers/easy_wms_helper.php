...
/**
 * Mendapatkan list jenis barang
 */
function getJenis()
{
    $CI =& get_instance();
    return $CI->db->get('jenis_barang')->result();
}

/**
 * Mendapatkan list jenis memory
 */
function getJenisMemory()
{
    $CI =& get_instance();
    return $CI->db->get('jenis_memory')->result();
}

/**
 * Mendapatkan list jenis hdd
 */
function getJenisHdd()
{
    $CI =& get_instance();
    return $CI->db->get('jenis_hdd')->result();
}

/**
 * Mendapatkan list status aset
 */
function getStatusAset()
{
    $CI =& get_instance();
    return $CI->db->get('status_aset')->result();
}
...
{
    $CI =& get_instance();
    return $CI->db->get('cabang')->result();
}
