...
class Penilaian_cepat_korban_luka_model extends MY_Model
{
    protected $table = 'penilaian_cepat_korban_luka';
    ...
    public function getDefaultValues()
    {
        return [
            ...
            'penyakit_rawat_jalan'          => '',
            'jumlah_gangguan_jiwa_anak'     => '',
            'jumlah_gangguan_jiwa_dewasa'   => '',
        ];
    }
    ...
    public function run($input)
    {
        $data = [
            ...
            'penyakit_rawat_inap'           => $input->penyakit_rawat_inap,
            'jumlah_rawat_jalan_laki'       => $input->jumlah_rawat_jalan_laki,
            'jumlah_rawat_jalan_perempuan'  => $input->jumlah_rawat_jalan_perempuan,
            'penyakit_rawat_jalan'          => $input->penyakit_rawat_jalan,
            'jumlah_gangguan_jiwa_anak'     => $input->jumlah_gangguan_jiwa_anak,
            'jumlah_gangguan_jiwa_dewasa'   => $input->jumlah_gangguan_jiwa_dewasa
        ];
